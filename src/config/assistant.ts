...
const verifiedFacts = () =>
  [
    ...
    "Kancheepuram, Madras School of Social Work, Sathyabama, SRM, BSA Crescent, Sairam,",
    "Kalasalingam, Vels, LEAD College (Autonomous) Palakkad, Achariya College of Engineering",
    "Technology Pondicherry, D.G. Vaishnav College, St. Joseph's College of Engineering",
    "(Jeppiaar Group) OMR, Jeppiaar University, Velammal, Amity Global Business School and the",
    "Dhanalakshmi Srinivasan Group (Chennai, Perambalur, Samayapuram and Coimbatore).",
    "",
